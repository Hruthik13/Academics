package table.academics.Subject_Wise_Marks.DTO;
...
public class SubjectMarksDTO {
    ...
    public SubjectMarksDTO(String id, String studentId, String subject_1, String subject_2, String subject_3, double marks_1, double marks_2, double marks_3, String created_by, Date creation_time, String last_Modified_by, Date last_Modification_time, int isDeleted, String deleted_by, Date deletion_time, String name){
        this.id=id;
